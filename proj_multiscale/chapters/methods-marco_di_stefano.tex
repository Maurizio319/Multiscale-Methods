...
%  
% The \textit{bond\_style} that was set for the LAMMPS simulations, and that regulates the interactions generated among beads
...
\begin{itemize}
    ...
    % \begin{enumerate} %#TODO unit of measures
    %     \item $30.0\; N$: Maximum force the bond can withstand. It represents the stiffness or strength of the bond.
